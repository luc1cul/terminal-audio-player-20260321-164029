...
- Windows XP-inspired glossy media deck with blue-glass chrome, WMP-style mode tabs, title-bar window controls, a richer transport cluster, responsive album-glass tile styling, animated marquee text, source badges, dual drive meters, and responsive narrow-layout fallbacks
- Animated spectrum, crest + undertow wave stack, reflection, glow, preset shelf controls, and signal ladder visualizer keyed to playback state
